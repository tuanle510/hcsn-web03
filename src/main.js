...
import LisenceDialog from "./components/dialog/MISALisenceDialog.vue";
...
// app.component("MISADropdown", VueMultiselect);

// Dialog
app.component("MISAAssetDialog", AssetDialog);
app.component("MISALisenceDialog", LisenceDialog);
